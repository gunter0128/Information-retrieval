...
# Corpus file path
CORPUS_FILE_PATH = "./data/IRTM/"# ## Load Data
...
def chi_square(C: dict, D: pd.DataFrame):
    ...
    # 最終需要的 500 字
    vocabulary = sorted(chi2, key=chi2.get, reverse=True)[:300] 
    return vocabulary 
    ...
    for c in C:
        ...
        for term in tf:
            if term in vocabulary:
                ...
                # 取 log 是相加，因此出現多次時不應該用次方算，應該用相乘才對
